...
\img{strategy-1}{.5\linewidth}{high-level view of the algorithm for strategy 1}
...
\img{strategy-2}{.5\linewidth}{high-level view of the algorithm for strategy 2}
...
\img{strategy-3}{.5\linewidth}{high-level view of the algorithm for strategy 3}
...
\img{strategy-4}{.5\linewidth}{high-level view of the algorithm for strategy 4}
